      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-5">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          {pillars.map((it) => (
            <Card
              key={it.title}
              className="bridge-card flex flex-col overflow-hidden border border-white/70 bg-white/85 shadow-lg backdrop-blur-xl transition-shadow hover:shadow-xl max-md:bg-white/96 max-md:backdrop-blur-none"
            >
              <div className="border-b border-white/60 bg-white/55 px-5 py-4 backdrop-blur-sm max-md:bg-white/92 max-md:backdrop-blur-none">
        ...
        <div className="mt-16 rounded-[2rem] bridge-inroom-copy p-8 shadow-lg lg:p-12">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
            ...
            <div className="rounded-2xl border border-white/60 bg-white/75 p-6 shadow-inner backdrop-blur-md max-md:bg-white/96 max-md:backdrop-blur-none lg:p-8">
